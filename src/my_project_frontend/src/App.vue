  ...
  <main class="container mx-auto">
    ...
    <form class="grid gap-4 pb-4 mb-4 border-solid border-b-2 border-sky-500" action="#" @submit="handleSubmit">
              ...
              px-4
               outline-none
                min-h-[100px]
                 ...
                 duration-150
                 ease-in-out
                    hover:border-indigo-500"></textarea>
          </div>
      <div>
      ...
      bg-indigo-400
        ...
        y-1
        px-4 
        hover:scale-110" type="submit">Click to add!</button>
    </div>
    </form>
    <div>
    <div v-for="blog in blogs" class="pb-4 border-solid border b-2 border-indigo-500">
